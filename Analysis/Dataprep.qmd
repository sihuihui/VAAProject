...
The dataset *weather_data_imputed* was the starting dataset for further analysis - [Exploratory Data Analysis](EDA.html), [Confirmatory Data Analysis](CDA.html) and [Forecasting](Forecasting.html).
