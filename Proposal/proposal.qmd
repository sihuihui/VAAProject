...
-   What are the trends in wind speed across the years?
...
-   Data Preparation
    ...
    -   To make use of daily weather data from 1983 to 2023

    -   Downloaded from [weather.gov.sg](https://www.weather.gov.sg/home/)

-   Exploratory Data Analysis (EDA)

    -   Trend of mean temperature, rainfall, and wind speed across years

    -   Trend of mean monthly temperature, rainfall, and wind speed
...
-   CDA Analysis
    ...
    -   One way anova on temperature by weather stations?

    -   One way anova on rainfall by weather stations?
